...
export class PlaceHierarchy1782838391831 implements MigrationInterface {
    name = 'PlaceHierarchy1782838391831'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_place" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" varchar NOT NULL, "type" varchar NOT NULL, "grid_x" integer NOT NULL, "grid_y" integer NOT NULL, "width" integer NOT NULL DEFAULT (1), "height" integer NOT NULL DEFAULT (1), "isRegion" boolean NOT NULL DEFAULT (0), "depth" integer NOT NULL DEFAULT (0), "parentId" integer)`);
        await queryRunner.query(`INSERT INTO "temporary_place"("id", "name", "description", "type", "grid_x", "grid_y", "width", "height") SELECT "id", "name", "description", "type", "grid_x", "grid_y", "width", "height" FROM "place"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "place" RENAME TO "temporary_place"`);
        await queryRunner.query(`CREATE TABLE "place" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" varchar NOT NULL, "type" varchar NOT NULL, "grid_x" integer NOT NULL, "grid_y" integer NOT NULL, "width" integer NOT NULL DEFAULT (1), "height" integer NOT NULL DEFAULT (1), "isRegion" boolean NOT NULL DEFAULT (0), "depth" integer NOT NULL DEFAULT (0), "parentId" integer)`);
        await queryRunner.query(`INSERT INTO "place"("id", "name", "description", "type", "grid_x", "grid_y", "width", "height", "isRegion", "depth", "parentId") SELECT "id", "name", "description", "type", "grid_x", "grid_y", "width", "height", "isRegion", "depth", "parentId" FROM "temporary_place"`);
        await queryRunner.query(`DROP TABLE "temporary_place"`);
        await queryRunner.query(`ALTER TABLE "place" RENAME TO "temporary_place"`);
        await queryRunner.query(`CREATE TABLE "place" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" varchar NOT NULL, "type" varchar NOT NULL, "grid_x" integer NOT NULL, "grid_y" integer NOT NULL, "width" integer NOT NULL DEFAULT (1), "height" integer NOT NULL DEFAULT (1))`);
        await queryRunner.query(`INSERT INTO "place"("id", "name", "description", "type", "grid_x", "grid_y", "width", "height") SELECT "id", "name", "description", "type", "grid_x", "grid_y", "width", "height" FROM "temporary_place"`);
        await queryRunner.query(`DROP TABLE "temporary_place"`);
    }
